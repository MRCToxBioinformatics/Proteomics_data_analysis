...
To identify the position of the phosphosite, the PhosphoRS[@http://zotero.org/users/5634351/items/TZ6QFFXY] algorithm is used in PD. Below, we filter the phospho-peptide to retain those with high confidence phosphosite localisation (phosphoRS\>75).
...
```{r, eval=FALSE}
saveRDS(psm_filt_sn_int, './results/benchmark_tmt_phospho_psm_filt.rds')
```
