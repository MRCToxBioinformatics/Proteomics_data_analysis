...
Here, we have so many significant tests that the uniform distribution is hard to assess. Excluding the clear peak for very low p-values (<0.05), we also have a slight skew towards low p-values in the range 0.05-0.15. This may indicate insufficient statistical power to detect some proteins that are truly enriched upon CL.  
```{r}
