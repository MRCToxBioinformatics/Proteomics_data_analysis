...
library(test.Proteomics.data.analysis)
library(camprotR)
library(Biostrings)
library(ggplot2)
library(MSnbase)
...
crap_fasta_inf <- system.file(
  ...
  package = "test.Proteomics.data.analysis"
)
...
pep_data_parsed <- lapply(
  pep_infiles, function(infile) { # define the function to run
    ...
    infdata <- read.delim(
      system.file("extdata", infile, package = "test.Proteomics.data.analysis"))
...
read.delim(system.file("extdata", pep_infiles[[1]], package = "test.Proteomics.data.analysis")) %>% colnames()
# Create a unified peptide sequence to protein assignment
new_seq_to_master <- pep_infiles %>%
  lapply(function(x) system.file("extdata", x, package = "test.Proteomics.data.analysis")) %>%
