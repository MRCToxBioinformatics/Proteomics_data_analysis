...
<figure>
  ...
  <figcaption>The principle of SILAC. Source: https://www.creative-proteomics.com/blog/index.php/stable-isotope-labeling-using-amino-acids-in-cell-culture-silac-principles-workflow-and-applications </figcaption>
</figure> 
...
Typically, the incorporation rate testing will be performed for you by the Proteomics service. However, should you wish to do this yourself, see [Asssessing the SILAC isotope incorporation rate](https://mrctoxbioinformatics.github.io/Proteomics_data_analysis/Markdowns/SILAC_incorporation.html)
...
Below, we define the filepaths for the 'PeptideGroup.txt' files we will use. These are part the Proteomics.analysis.data package - their complete filepath can be identified using `system.file`
```{r}
